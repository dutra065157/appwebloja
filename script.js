// Classe Carrinho (mantida igual ao index.html)
        ...
        function renderizarProdutos(produtosParaRenderizar) {
            ...
            container.innerHTML = produtosParaRenderizar.sort((a, b) => a.nome.localeCompare(b.nome)).map((produto, index) => {
                ...
                if (produto.novo && !badges.length) { // Mostra 'Novo' apenas se não tiver outro badge
                    badges.push(`
                ...
                if (produto.mais_vendido && !badges.length) { // Mostra 'Mais Vendido' apenas se não tiver outro badge
                    badges.push(`
                ...
                <div class="product-card group bg-white rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 border border-gray-100 animate-fade-in-up"
                    ...
                    <div class="relative overflow-hidden">
                        ...
                        ${temImagem ? 
                            ...
                            `<div class="w-full h-48 ${produto.cor_gradiente || 'from-gray-400 to-gray-600'} bg-gradient-to-br flex items-center justify-center group-hover:scale-105 transition-transform duration-500">
